...
# scripts/mod/devicetable-offsets.c -mcmodel=medany -mabi=lp64d
# -march=rv64gcxthead -mglibc -mabi=lp64 -march=rv64imac -mno-save-restore
# -mcmodel=medany -mstrict-align
# -auxbase-strip scripts/mod/devicetable-offsets.s -Os -Os -Wall -Wundef
